...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <aside 
        className={`fixed lg:static inset-y-0 left-0 z-50 w-64 bg-slate-950 flex flex-col h-full border-r border-slate-800/80 transition-transform duration-300 ease-in-out relative ${
